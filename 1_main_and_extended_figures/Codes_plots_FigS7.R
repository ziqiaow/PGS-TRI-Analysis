...
pdf("./family/manuscript/plots/final/Extended_Figure7_09152024.pdf")
par(mfrow=c(2,3))
qqplot(res_pgs_main$p_clp_all,title="All Population (#Trios = 1466); DE",col_point = "royal blue")
...
qqplot(res_nurture$p_clp_all,title="All Population (#Trios = 1466); \u03B4-IDE",col_point = "dark green")
...
#mtext("RNAseq Transcriptome-Wide Association Study in OFCs (#genes=4991)", side = 3, line = -1.5, outer = TRUE,cex=1)

dev.off()


png("./family/manuscript/plots/final/Extended_Figure7_09152024.png",width=10, height=6, units="in", res=320)
par(mfrow=c(2,3))
qqplot(res_pgs_main$p_clp_all,title="All Population (#Trios = 1466); DE",col_point = "royal blue")
qqplot(res_pgs_main$p_clp_EUR,title="EUR (#Trios = 575); DE",col_point = "royal blue")
qqplot(res_pgs_main$p_clp_AS,title="Asian (#Trios = 891); DE",col_point = "royal blue")
