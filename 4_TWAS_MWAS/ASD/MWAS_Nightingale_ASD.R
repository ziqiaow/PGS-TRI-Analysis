...
#all
pgs_main=PGS.TRI(prs_pgscatalog_complete$offspring_prs_standardized,
                 prs_pgscatalog_complete$mother_prs_standardized,
                 prs_pgscatalog_complete$father_prs_standardized, 
                 GxE_int = FALSE,
                 parental_indirect = T)
...
#all no AMR
data.model2=prs_pgscatalog_complete[-which(prs_pgscatalog_complete$race=="AMR"),]
...
#EUR
data.model2=prs_pgscatalog_complete[which(prs_pgscatalog_complete$race=="EUR"),]
pgs_main=PGS.TRI(data.model2$offspring_prs_standardized,
                 data.model2$mother_prs_standardized,
                 data.model2$father_prs_standardized, 
                 GxE_int = FALSE,
...
#AFR
data.model2=prs_pgscatalog_complete[which(prs_pgscatalog_complete$race=="AFR"),]
pgs_main=PGS.TRI(data.model2$offspring_prs_standardized,
                 data.model2$mother_prs_standardized,
                 data.model2$father_prs_standardized, 
                 GxE_int = FALSE,
...
#EAS/SAS
data.model2=prs_pgscatalog_complete[which(prs_pgscatalog_complete$race=="EAS" | prs_pgscatalog_complete$race=="SAS"),]
pgs_main=PGS.TRI(data.model2$offspring_prs_standardized,
                 data.model2$mother_prs_standardized,
                 data.model2$father_prs_standardized, 
                 GxE_int = FALSE,
...
save(res_pgs_main,res_nurture,file=paste0("/dcs04/nilanjan/data/zwang/phewas/plink/results/summary/redo/",type,"_results.RData"))
