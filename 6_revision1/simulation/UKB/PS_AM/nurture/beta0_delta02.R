...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_size1_corrected,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,file=paste0(path,"res_beta0_delta02_size1k",".rda"))
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_size1_corrected,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,file=paste0(path,"res_beta0_delta02_size2k",".rda"))
