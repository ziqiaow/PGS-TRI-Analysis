...
path<-"/dcs04/nilanjan/data/zwang/family/simulation/new_score/PGS002440_clump/PS_AM/nurture/multichild/"
...
for(i in 1:125){
  ...
  dat = sim_prospective_population(pgs_c = pgs_c , pgs_f = pgs_f,pgs_m = pgs_m,e_strat = bmi,cor_strat = 2,alpha_fam = -6.2,pc=F,mu_pc = mu_sim,betaG_normPRS=0,nurture = T,beta_M=beta_M_tmp,beta_F=beta_F_tmp)
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_size1_corrected,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,file=paste0(path,"res_beta0_delta0_size1k",".rda"))
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_size1_corrected,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,file=paste0(path,"res_beta0_delta0_size2k",".rda"))