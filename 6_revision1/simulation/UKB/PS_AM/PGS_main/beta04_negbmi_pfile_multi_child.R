...
path<-"/dcs04/nilanjan/data/zwang/family/simulation/new_score/PGS002440_clump/PS_AM/PGS_main/"
...
load("/dcs04/nilanjan/data/zwang/family/simulation/new_score/PGS002440_clump/pgs/PGS_parents_id_R_pfile.RData")
...
for(i in 1:125){
  ...
  load(paste0("/dcs04/nilanjan/data/zwang/family/simulation/new_score/PGS002440_clump/child_geno/child_pgs_",i,".RData"))
  pgs_c = pgs_c[id]
