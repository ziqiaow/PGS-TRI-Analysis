#scenario 5: no population stratification bias
#PGS -> D, PGS_m,PGS_f-> Z (selection)
...
for(i in 1:sim_N){
  set.seed(i)
  dat=sim_prospective_population_parents(n_fam=600000,cor_strat=cor_strat1,alpha_fam=-5.5,betaG_normPRS=beta_prs, beta_select_E1=0.4,beta_select_parents = 0.2 , envir = FALSE)
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_parent_size1,
     file=paste0(path,"s5_pgs04_cor0",".rda"))
