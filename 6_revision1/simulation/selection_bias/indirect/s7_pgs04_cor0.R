#scenario 7: no population stratification bias
#PGS -> D, PGS_m,PGS_f-> Z (selection), mother father different selection magnitude
...
for(i in 1:sim_N){
  set.seed(i)
  dat=sim_prospective_population_parents(n_fam=600000,beta_select_m = 0.2 ,beta_select_f = 0, cor_strat=cor_strat1,alpha_fam=-5.2,betaG_normPRS=beta_prs, beta_select_E1=0.4,envir = FALSE)
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_parent_size1,
     file=paste0(path,"s7_pgs04_cor0",".rda"))
