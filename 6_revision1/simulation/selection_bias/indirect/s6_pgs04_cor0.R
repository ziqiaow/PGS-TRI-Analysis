#scenario 6: no population stratification bias
#PGS -> D, E -> D, E,PGS_f,PGS_m-> Z (selection), PGS and E independent
...
for(i in 1:sim_N){
  set.seed(i)
  dat=sim_prospective_population_parents(n_fam=600000,cor_strat=cor_strat1,alpha_fam=-5.5,betaG_normPRS=beta_prs, beta_select_E1=0.4, envir = T)
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_fam_parent_size1,
     file=paste0(path,"s6_pgs04_cor0",".rda"))
