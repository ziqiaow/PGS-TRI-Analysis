...
#Feb 17, 2025
#--------------------------------------------------
sim_prospective_population=function(pgs_c,pgs_m,pgs_f,cor_strat=0.5,alpha_fam=-5,betaG_normPRS=0.4,beta_M=0,beta_F=0){
    ...
    alpha_sim = rnorm(length(pgs_c),mean = alpha_fam+cor_strat*0.5*(pgs_m + pgs_f), sd = 1)
