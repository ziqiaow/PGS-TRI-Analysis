...
path<-"/dcs04/nilanjan/data/zwang/family/simulation/match_geo/05142024/"
...
load("/dcs04/nilanjan/data/zwang/family/simulation/match_geo/PGS_parents_id_R.RData")
...
for(i in 1:sim_N){
  ...
  load(paste0("/dcs04/nilanjan/data/zwang/family/simulation/match_geo/child_geno/child_pgs_",i,".RData"))
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_pc_father,res_pc_mother,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,res_pc_famo,file=paste0(path,"res_beta0_size1k",".rda"))
...
for(i in 1:sim_N){
  ...
  #first without PCs in the intercept term
  dat = sim_prospective_population(pgs_c = pgs_c , pgs_f = pgs_f,pgs_m = pgs_m,e_strat = bmi,cor_strat = 2,alpha_fam = -5.5,pc=F,mu_pc = mu_sim,betaG_normPRS=0)
  ...
  # res_glm_edu_fam_size1[[i]]=summary(fit_edu)$coef
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_pc_father,res_pc_mother,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,res_pc_famo,file=paste0(path,"res_beta0_size2k",".rda"))
...
for(i in 1:sim_N){
  ...
  #first without PCs in the intercept term
  dat = sim_prospective_population(pgs_c = pgs_c , pgs_f = pgs_f,pgs_m = pgs_m,e_strat = bmi,cor_strat = 2,alpha_fam = -5.2,pc=F,mu_pc = mu_sim,betaG_normPRS=0)
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,res_pc_father,res_pc_mother,
     res_glm_pc10_fam_size1,res_glm_pc10_geo_fam_size1,res_pc_famo,file=paste0(path,"res_beta0_size3k",".rda"))
