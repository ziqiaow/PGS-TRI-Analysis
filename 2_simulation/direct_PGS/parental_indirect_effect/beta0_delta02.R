...
for(i in 1:sim_N){
  dat=sim_prospective_population(n_fam=300000,cor_strat=cor_strat1,alpha_fam=-5.2,betaG_normPRS=beta_prs,envir=FALSE,nurture=TRUE,beta_M=beta_M_tmp,beta_F=beta_F_tmp)
...
save(res_fam_size1,res_glm_fam_size1,
     ...
     res_fam_size4,res_glm_fam_size4,file=paste0(path,"beta0_delta02_",task_id,".rda"))
