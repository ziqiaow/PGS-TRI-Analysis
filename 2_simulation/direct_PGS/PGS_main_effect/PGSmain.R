path<-"./family/simulation/04262023/"
source("./family/simulation.R")
...
for(i in 1:sim_N){
  set.seed(i)
  dat=sim_prospective_population(n_fam=600000,cor_strat=cor_strat1,alpha_fam=-5.5,betaG_normPRS=beta_prs,envir=FALSE)
  ...
  res_fam_size1[[i]]=PGS.TRI(prs_offspring = PRS_fam[,1], prs_mother = PRS_fam[,2], prs_father=PRS_fam[,3], side=2,GxE_int = FALSE)$res_beta
  ...
  res_fam_size2[[i]]=PGS.TRI(prs_offspring = PRS_fam[,1], prs_mother = PRS_fam[,2], prs_father=PRS_fam[,3], side=2,GxE_int = FALSE)$res_beta
  fit <- glm(D ~ G_logistic, family = binomial(), model = FALSE, x = FALSE, y = FALSE)
  ...
  res_fam_size3[[i]]=PGS.TRI(prs_offspring = PRS_fam[,1], prs_mother = PRS_fam[,2], prs_father=PRS_fam[,3], side=2,GxE_int = FALSE)$res_beta
  fit <- glm(D ~ G_logistic, family = binomial(), model = FALSE, x = FALSE, y = FALSE)
  ...
  res_fam_size4[[i]]=PGS.TRI(prs_offspring = PRS_fam[,1], prs_mother = PRS_fam[,2], prs_father=PRS_fam[,3], side=2,GxE_int = FALSE)$res_beta
  fit <- glm(D ~ G_logistic, family = binomial(), model = FALSE, x = FALSE, y = FALSE)
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,
     ...
     res_fam_size4,res_glm_fam_size4,res_ptdt_size4,file=paste0(path,"sim_beta_prs_0_cor_0",".rda"))
...
#Scenario: type 1 error, beta_prs=0, cor_strat=0.25
beta_prs=0
cor_strat1=0.25
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,
     res_fam_size2,res_glm_fam_size2,res_ptdt_size2,
     res_fam_size3,res_glm_fam_size3,res_ptdt_size3,
     res_fam_size4,res_glm_fam_size4,res_ptdt_size4,file=paste0(path,"sim_beta_prs_0_cor_025",".rda"))
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,
     res_fam_size2,res_glm_fam_size2,res_ptdt_size2,
     res_fam_size3,res_glm_fam_size3,res_ptdt_size3,
     res_fam_size4,res_glm_fam_size4,res_ptdt_size4,file=paste0(path,"sim_beta_prs_04_cor_025",".rda"))
...
#Scenario: type 1 error, beta_prs=0.4, cor_strat=0
beta_prs=0.4
cor_strat1=0
...
save(res_fam_size1,res_glm_fam_size1,res_ptdt_size1,
     res_fam_size2,res_glm_fam_size2,res_ptdt_size2,
     res_fam_size3,res_glm_fam_size3,res_ptdt_size3,
     res_fam_size4,res_glm_fam_size4,res_ptdt_size4,file=paste0(path,"sim_beta_prs_04_cor_0",".rda"))
