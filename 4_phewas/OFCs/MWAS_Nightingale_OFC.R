...
for(j in 1:length(filenames)){
  ...
  #all/all
  pgs_main=PGS.TRI(data.model$offspring_prs_standardized,
                   data.model$mother_prs_standardized,
                   data.model$father_prs_standardized, 
                   GxE_int = FALSE,
                   parental_indirect = T)
  ...
  #EUR/all
  data.model2=data.model[which(data.model$proband_race2=="EUR" ),]
  ...
  #EUR/all
  data.model2=data.model[which(data.model$proband_race2=="ASA" ),]
  pgs_main=PGS.TRI(data.model2$offspring_prs_standardized,
                   data.model2$mother_prs_standardized,
                   data.model2$father_prs_standardized, 
                   GxE_int = FALSE,
  ...
  #EUR, CL/P
  data.model2=data.model[which(data.model$proband_race2=="EUR" & data.model$clp=="CL/P"),]
  pgs_main=PGS.TRI(data.model2$offspring_prs_standardized,
                   data.model2$mother_prs_standardized,
                   data.model2$father_prs_standardized, 
                   GxE_int = FALSE,
  ...
  #Asian, CL/P
  data.model2=data.model[which(data.model$proband_race2=="ASA"  & data.model$clp=="CL/P"),]
  pgs_main=PGS.TRI(data.model2$offspring_prs_standardized,
                   data.model2$mother_prs_standardized,
                   data.model2$father_prs_standardized, 
                   GxE_int = FALSE,
